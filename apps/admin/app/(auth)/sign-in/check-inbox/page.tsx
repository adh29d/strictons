...
/**
 * Admin-app post-submission confirmation. Brief admin-context wording
 * so a confused recipient who has two pending Strictons sign-in
 * emails (admin + partners) knows which one this confirmation is
 * about. Otherwise structurally identical to the partners-side
 * check-inbox.
 */
