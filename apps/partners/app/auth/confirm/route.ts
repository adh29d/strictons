...
/**
 * GET /auth/confirm?token_hash=…&type=email&next=/  (partners app)
 *
 ...
 * /auth/confirm handler has used this pattern since commit 6. Magic-
 * link verification is the highest-stakes error path in the entire
 * auth flow; server-side error capture is non-negotiable here.
 */
